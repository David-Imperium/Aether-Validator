...
use std::sync::Arc;
use aether_validation::ValidationContext;
use aether_parsers::{RustParser, Parser};
...
fn count_ast_nodes(ast: &aether_parsers::AST, total_lines: usize) -> AstStats {
...
fn count_nodes(node: &aether_parsers::ASTNode, stats: &mut AstStats) {
