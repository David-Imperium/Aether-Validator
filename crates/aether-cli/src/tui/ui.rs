...
fn render_header(f: &mut ratatui::Frame, app: &App, area: Rect) {
    let title = Line::from(vec![
        Span::styled(" AETHER ", Style::default().fg(CYAN).add_modifier(Modifier::BOLD)),
...
fn render_menu(f: &mut ratatui::Frame, app: &App, area: Rect) {
    ...
    let info_lines = vec![
        Line::from(""),
        Line::from(Span::styled("  Welcome to Aether", Style::default().fg(CYAN).add_modifier(Modifier::BOLD))),
        Line::from(""),
...
fn render_dashboard(f: &mut ratatui::Frame, app: &App, area: Rect) {
    ...
    let project_lines = vec![
        ...
        Line::from(vec![
            ...
            Span::styled("  (.aether.toml)", Style::default().fg(Color::DarkGray)),
        ]),
        Line::from(vec![
...
fn render_validate(f: &mut ratatui::Frame, _app: &App, area: Rect) {
    let lines = vec![
        ...
        Line::from(""),
        Line::from(Span::styled("    aether validate <file>                       # Single file", Style::default().fg(Color::White))),
        Line::from(Span::styled("    aether validate src/                         # Directory", Style::default().fg(Color::White))),
        Line::from(Span::styled("    aether validate src/main.rs --lang rust      # Explicit language", Style::default().fg(Color::White))),
        Line::from(Span::styled("    aether validate src/ --format json           # JSON output", Style::default().fg(Color::White))),
        Line::from(Span::styled("    aether validate src/ --severity error        # Errors only", Style::default().fg(Color::White))),
        Line::from(""),
        ...
        Line::from(Span::styled("    aether validate file.rs --accept SYN001,SEC002 --reason \"intended\"", Style::default().fg(Color::White))),
    ];
...
fn render_config(f: &mut ratatui::Frame, app: &App, area: Rect) {
    ...
    if let Some(cfg) = config {
        lines.push(Line::from(Span::styled("  Configuration (.aether.toml)", Style::default().fg(CYAN).add_modifier(Modifier::BOLD))));
        lines.push(Line::from(""));
        lines.push(Line::from(vec![
        ...
        lines.push(Line::from(""));
        lines.push(Line::from(Span::styled("  [Enter] Save  |  [←/→] Change preset  |  Edit .aether.toml for full control", Style::default().fg(YELLOW))));
    } else {
        lines.push(Line::from(""));
        lines.push(Line::from(Span::styled("  No .aether.toml found", Style::default().fg(Color::Red))));
        lines.push(Line::from(""));
...
fn render_memory(f: &mut ratatui::Frame, app: &App, area: Rect) {
    ...
    let lines: Vec<Line> = if entries.is_empty() {
        vec![
            ...
            Line::from(Span::styled("    - Adjust thresholds in .aether.toml", Style::default().fg(Color::White))),
            ...
            Line::from(Span::styled("    aether memory list                    List all entries", Style::default().fg(DIM))),
            Line::from(Span::styled("    aether memory recall why-exists <fn>  Why does this code exist?", Style::default().fg(DIM))),
            Line::from(Span::styled("    aether memory recall who-calls <fn>   Who calls this function?", Style::default().fg(DIM))),
            Line::from(Span::styled("    aether memory recall search <query>   Semantic search", Style::default().fg(DIM))),
        ]
    } else {
        let mut l = vec![
            Line::from(""),
...
fn render_mcp(f: &mut ratatui::Frame, app: &App, area: Rect) {
    ...
    let status_line = match platform.status {
        PlatformStatus::Configured => Line::from(Span::styled("  Status: Aether MCP already configured", Style::default().fg(Color::Green))),
        PlatformStatus::Detected => Line::from(Span::styled("  Status: Platform found, Aether not configured", Style::default().fg(YELLOW))),
...
fn render_help(f: &mut ratatui::Frame, area: Rect) {
    let lines = vec![
        Line::from(""),
        Line::from(Span::styled("  Aether TUI — Help", Style::default().fg(CYAN).add_modifier(Modifier::BOLD))),
        Line::from(""),
        Line::from(Span::styled("  Navigation", Style::default().fg(YELLOW))),
        ...
        Line::from(Span::styled("    3  Config         Edit .aether.toml", Style::default().fg(Color::White))),
        ...
        Line::from(""),
        Line::from(Span::styled("  What is Aether?", Style::default().fg(YELLOW))),
        Line::from(Span::styled("    Aether validates AI-generated code through formal rules,", Style::default().fg(DIM))),
        Line::from(Span::styled("    contracts, and learned patterns. It works as:", Style::default().fg(DIM))),
        Line::from(Span::styled("    - CLI tool (aether validate, certify, analyze)", Style::default().fg(DIM))),
