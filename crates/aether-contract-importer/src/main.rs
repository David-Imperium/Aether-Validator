//! Aether Contract Importer CLI
//!
//! Usage: aether-contract-importer [OPTIONS] [OUTPUT_DIR]
//!
//! Examples:
//!   aether-contract-importer                    # Export to ~/.aether/contracts/imported/
//!   aether-contract-importer ./output           # Export to ./output/
//!   aether-contract-importer --format markdown  # Generate markdown docs
...
#[derive(Parser)]
#[command(name = "aether-contract-importer")]
...
struct Cli {
    ...
    #[arg(default_value = "~/.aether/contracts/imported")]
    output: PathBuf,
