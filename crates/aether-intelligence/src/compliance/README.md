...
Aether's compliance system provides intelligent contract enforcement with context-aware learning and tiered enforcement levels.
...
```rust
use aether_intelligence::compliance::{ContractClassifier, ContractTier};
...
let store = ExemptionStore::with_path(".aether/exemptions.json".into());
...
exemption_store_path = ".aether/exemptions.json"
```
