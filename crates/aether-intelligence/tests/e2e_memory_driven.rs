...
//! 1. Load project config from .aether.toml
...
/// Test: Project config loads from .aether.toml
#[test]
fn test_project_config_loads_from_toml() {
    let dir = setup_test_project();
    let config_path = dir.path().join(".aether.toml");
...
"#;
    ...
    learned.custom_rules.push(CustomRule {
        ...
        is_regex: false,
        severity: aether_intelligence::memory::Severity::Warning,
        applies_to: vec!["**/*.rs".to_string()],
        confidence: 0.8,
