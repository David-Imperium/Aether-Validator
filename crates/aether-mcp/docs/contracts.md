...
### Via CLI
```bash
aether validate src/main.rs --contracts no_unsafe,documentation
```

## Custom Contracts

You can define custom contracts in a `.aether/contracts/` directory.

```rust
// .aether/contracts/my_contract.rs
