...
```python
"""
Custom Aether validation contract for Python
...
from aether_contracts import Contract, ValidationError, ASTNode
...
1. Save as `.aether/contracts/my_python_contract.py`
2. Run: `aether validate main.py --contracts my_python_contract`
