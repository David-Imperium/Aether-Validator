...
pub struct ComplianceResult {
    ...
    /// Compliance decision
    pub decision: aether_intelligence::compliance::ComplianceDecision,
...
pub struct ComplianceLayer {
    ...
    engine: Option<aether_intelligence::compliance::ComplianceEngine>,
}
...
impl ComplianceLayer {
    ...
    fn ensure_engine(&mut self) -> &mut aether_intelligence::compliance::ComplianceEngine {
        if self.engine.is_none() {
            let engine_config = aether_intelligence::compliance::ComplianceConfig {
            ...
            self.engine = Some(
                aether_intelligence::compliance::ComplianceEngine::with_config(engine_config)
    ...
    pub async fn evaluate_violation(
        ...
        use aether_intelligence::compliance::ComplianceContext;
        ...
        let dubbioso_message = if needs_input {
            match &decision.action {
                aether_intelligence::compliance::ComplianceAction::Ask { question, options } => {
