...
pub async fn check() -> Result<()> {
    ui::print_banner("SYNWARD CONTRACTS");
    ...
    if !contracts_dir.exists() {
        ...
        ui::print_info("Run 'synward init' first");
        return Ok(());
    }
    ...
    if !has_contracts {
        ...
        ui::print_info("Run 'synward contracts update' to download");
        return Ok(());
    }
...
pub async fn update(args: ContractsUpdateArgs) -> Result<()> {
    ui::print_banner("SYNWARD CONTRACTS UPDATE");
