...
//!
//! Usage: synward learn <project_path> --lang <language>
...
pub fn learn(project_path: &Path, lang: &str) -> Result<()> {
    ...
    println!("{}", "╔══════════════════════════════════════════════════════════════╗".cyan());
    println!("{} SYNWARD - Learning patterns from {}", "║".cyan(), project_path.display().to_string().bold());
    println!("{}", "╠══════════════════════════════════════════════════════════════╣".cyan());
    ...
    // Save to .synward/learned.toml
    let output_dir = project_path.join(".synward");
