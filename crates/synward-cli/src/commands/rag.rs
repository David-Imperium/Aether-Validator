...
/// RAG storage for Synward validation learning
pub struct SynwardRag {
...
impl SynwardRag {
    ...
    fn get_storage_path() -> Result<PathBuf> {
        ...
        if let Ok(data_dir) = std::env::var("SYNWARD_DATA_DIR") {
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            Ok(PathBuf::from(app_data).join("synward").join("rag"))
        }
        ...
        #[cfg(target_os = "linux")]
        {
            ...
            Ok(PathBuf::from(data_dir).join("synward").join("rag"))
        }
        ...
        #[cfg(not(any(target_os = "windows", target_os = "macos", target_os = "linux")))]
        {
            let home = std::env::var("HOME")
                .context("HOME not set")?;
            Ok(PathBuf::from(home).join(".synward").join("rag"))
        }
    }
