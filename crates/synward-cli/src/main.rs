//! Synward CLI - Code validation and certification tool
//!
//! Commands:
...
enum Commands {
    ...
    Validate {
        ...
        #[arg(long)]
        intent: bool,
        /// Save validation state to .synward/validation_state.json
        #[arg(long)]
        save_state: bool,
    ...
    /// Validate Synward's own source code (eat your own dog food)
    SelfValidate {
        #[arg(long, default_value = "warning")]
        severity: String,
        #[arg(long, default_value = "text")]
    ...
    /// Initialize Synward for your project
    Init {
        #[arg(short = 'L', long)]
        lang: Option<String>,
        #[arg(short = 'P', long)]
        ...
        Commands::Rag(cmd) => {
            match cmd {
                RagCommands::Search { query, lang, limit } => {
                    let rag = commands::SynwardRag::new()?;
                ...
                RagCommands::Stats => {
                    ...
                    println!("Synward RAG Statistics");
                    println!("======================");
            ...
            match action {
                ...
                HooksAction::List => {
                    ...
                    if installed.is_empty() {
                        println!("No Synward hooks installed.");
                    } else {
                        println!("Installed Synward hooks:");
                        for h in installed {
                            println!("  - {}", h);
                        }
                    }
