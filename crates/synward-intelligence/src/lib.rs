//! Synward Intelligence - Lightweight validation enhancement
//!
//! This crate provides intelligence layers for Synward validation:
//!
...
//!
//! let ai = SynwardIntelligence::new(Config::default())?;
//!
//! // Unified memory API
...
pub use contract_generator::{
    ...
    DocRuleType, ContractMetadata, SynwardContract,
};
...
/// Configuration for Synward Intelligence
...
/// Main entry point for Synward Intelligence
pub struct SynwardIntelligence {
    config: Config,
...
impl SynwardIntelligence {
    /// Create new Synward Intelligence instance
    ...
    ///
    /// This is the main entry point for the `synward recall` CLI command.
    #[cfg(feature = "memory")]
    ...
    pub fn validate_and_learn(
        ...
        // Ensure .synward directory exists
        let synward_dir = project_root.join(".synward");
