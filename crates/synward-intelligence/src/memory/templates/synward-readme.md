# .synward/ - Synward Memory Directory

This directory contains Synward's project-specific memory and configuration.
...
Synward learns from your validation decisions and stores them here.
