...
Returns Synward version, supported languages count, and tools count.
...
```json
{
  ...
  "result": {
    ...
    "instructions": "Synward MCP Server - Code validation, analysis, and certification..."
  }
}
```
