# Synward Quick Start Guide

## What is Synward?

Synward is a code validation and certification tool that provides:
...
### get_version
Get Synward version and capabilities:
```json
{}
```
...
# Certify code
synward certify src/main.rs --signer "Developer"
```

## Integration with Droid Skill

The `validate` skill uses Synward automatically when validating code files.
