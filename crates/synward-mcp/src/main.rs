//! Synward MCP Server - Optimized Version
//!
...
use synward_parsers::ParserRegistry;
use synward_validation::layers::ContractLayer;
use synward_validation::{ValidationContext, ValidationLayer};
use synward_intelligence::dubbioso::{DubbiosoConfig, ConfidenceLevel};
use synward_intelligence::dubbioso_validator::{DubbiosoValidator, ViolationInput};
...
// use synward_validation::scope::{ScopeAnalysisLayer, ScopeTree, SymbolKind};
// use synward_validation::type_inference::{TypeInferenceEngine, Type, TypeKind};
...
/// Global contract layer - loads YAML contracts from ~/.synward/contracts/
...
fn get_contracts_dir() -> PathBuf {
    ...
    // Then check home directory ~/.synward/contracts
    dirs::home_dir()
...
fn get_compliance_engine() -> &'static std::sync::Mutex<ComplianceEngine> {
    COMPLIANCE_ENGINE.get_or_init(|| {
        ...
        let config = ComplianceConfig {
            exemption_store_path: Some(synward_dir.join("exemptions.json")),
...
impl SynwardServer {
    ...
    #[tool(description = "Get Synward version and capabilities")]
...
#[tool_handler]
impl ServerHandler for SynwardServer {
    fn get_info(&self) -> ServerInfo {
        ...
        .with_server_info(Implementation::new("synward-mcp", env!("CARGO_PKG_VERSION")))
        .with_protocol_version(ProtocolVersion::V_2024_11_05)
        .with_instructions(
            "Synward MCP Server - Universal AI Code Validation Layer\n\
            \n\
            ...
            \n\
            RESOURCES: docs://synward/* for documentation, template://synward/* for contract templates\n\
            \n\
    ...
    async fn get_prompt(
        ...
        Ok(GetPromptResult::new(vec![PromptMessage::new_text(PromptMessageRole::User, msg)])
            .with_description("Synward validation prompt"))
    }
    ...
    async fn list_resources(
        ...
        Ok(ListResourcesResult {
            ...
            resources: vec![
                // Dynamic resources
                RawResource::new("synward://version", "Synward Version").no_annotation(),
                RawResource::new("synward://languages", "Supported Languages (23)").no_annotation(),
                RawResource::new("synward://contracts", "Validation Contracts (5)").no_annotation(),
                // Documentation
                RawResource::new("docs://synward/quickstart", "Quick Start Guide").no_annotation(),
                RawResource::new("docs://synward/languages", "Languages Reference").no_annotation(),
                RawResource::new("docs://synward/contracts", "Contracts Reference").no_annotation(),
                RawResource::new("docs://synward/certification", "Certification Process").no_annotation(),
                // Templates
                RawResource::new("template://synward/rust-contract", "Rust Contract Template").no_annotation(),
                RawResource::new("template://synward/python-contract", "Python Contract Template").no_annotation(),
                // Examples
                RawResource::new("example://synward/validation", "Validation Example").no_annotation(),
                RawResource::new("example://synward/certification", "Certification Example").no_annotation(),
            ],
            meta: None,
        })
    }
    ...
    async fn read_resource(
        ...
        let content = match uri {
            ...
            "docs://synward/quickstart" => include_str!("../docs/quickstart.md"),
            "docs://synward/languages" => include_str!("../docs/languages.md"),
            "docs://synward/contracts" => include_str!("../docs/contracts.md"),
            "docs://synward/certification" => include_str!("../docs/certification.md"),
            // Templates
            "template://synward/rust-contract" => include_str!("../templates/rust-contract.md"),
            "template://synward/python-contract" => include_str!("../templates/python-contract.md"),
            // Examples
            "example://synward/validation" => include_str!("../examples/validation.md"),
            "example://synward/certification" => include_str!("../examples/certification.md"),
...
async fn analyze_ast(code: &str, language: &str) -> Result<AnalyzeOutput> {
    ...
    fn count_nodes(node: &synward_parsers::ASTNode, depth: usize, types: &mut std::collections::HashMap<String, usize>, max_d: &mut usize) -> usize {
...
async fn main() -> Result<()> {
    ...
    eprintln!("[INFO] Starting Synward MCP Server v{}", VERSION);
    ...
    let server = SynwardServer::default();
