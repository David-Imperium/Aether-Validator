...
```rust
//! Custom Synward validation contract for Rust

use synward_contracts::{Contract, ValidationError, ASTNode};
...
1. Save as `.synward/contracts/my_custom_contract.rs`
2. Run: `synward validate src/main.rs --contracts my_custom_contract`
