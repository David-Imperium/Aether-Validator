...
//!
//! This layer runs `cargo clippy` and converts its warnings/errors to Synward violations.
...
///
/// Integrates rust-clippy lints into Synward validation pipeline.
...
impl ClippyLayer {
    ...
    /// Convert clippy diagnostic to Synward violation.
