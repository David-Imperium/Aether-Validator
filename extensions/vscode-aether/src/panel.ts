...
export class AetherPanel {
    public static currentPanel: AetherPanel | undefined;
    public static readonly viewType = 'aetherPanel';
    ...
    public static createOrShow(extensionUri: vscode.Uri, client: AetherClient) {
        const column = vscode.window.activeTextEditor
            ? vscode.window.activeTextEditor.viewColumn
            : undefined;
        
        if (AetherPanel.currentPanel) {
            AetherPanel.currentPanel._panel.reveal(column);
            return;
        }
        
        const panel = vscode.window.createWebviewPanel(
            AetherPanel.viewType,
            'Aether Validator',
        ...
        AetherPanel.currentPanel = new AetherPanel(panel, extensionUri, client);
    }
...
<body>
    ...
    public dispose() {
        AetherPanel.currentPanel = undefined;
