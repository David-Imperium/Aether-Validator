/**
 * Synward Diagnostics - VS Code diagnostic collection
 */

import * as vscode from 'vscode';
import { Violation } from './synwardClient';

export class SynwardDiagnostics {
    private collection: vscode.DiagnosticCollection;
    
    constructor() {
        this.collection = vscode.languages.createDiagnosticCollection('synward');
    }
